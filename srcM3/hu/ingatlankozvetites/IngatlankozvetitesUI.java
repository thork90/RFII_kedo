...
public class IngatlankozvetitesUI extends UI {
	...
	@VaadinServletConfiguration(productionMode = false, ui = IngatlankozvetitesUI.class)
	...
	protected void init(VaadinRequest request) {
		...
		if (session.getAttribute("MODE")!=null
				&&((Boolean)session.getAttribute("MODE"))){
...
//		layout.addComponent(ajTor);
	...
	public static boolean login(String nev,String jelszo) {
